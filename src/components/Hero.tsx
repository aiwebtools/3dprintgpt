          ...
          <div className="flex-1 text-center md:text-left space-y-8">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-6 justify-center md:justify-start">
              ...
              <Button 
                asChild 
                variant="outline" 
                className="border-2 border-cyber-blue text-cyber-blue hover:text-white hover:bg-gradient-to-r hover:from-cyber-blue/20 hover:to-cyber-purple/20 shadow-ethereal text-lg px-10 py-7 rounded-full font-semibold transition-all duration-500 hover-divine backdrop-blur-xl"
              >
